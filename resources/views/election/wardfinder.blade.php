...
@section('content')
    ...
    <h1>Find your ward</h1>

    <div class="whitecard" style="display:none;" id="found-ward">
        <h1></h1>
    </div>

    <div class="whitecard">
        <h2>Choose a neighbourhood</h2>
...
@section('scripts')
    ...
    <script>
        ...
        $('#neighbourhood-select').on("change", function (e) {
            ...
            var ward = $("#neighbourhood-select").val();

            $('#found-ward h1').html("You live in Ward " + ward + "!");
            $('#found-ward').show('fast');
        });
    </script>
